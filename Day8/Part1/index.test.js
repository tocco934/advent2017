const findMaxValue = require('./').maxRegisterValueCalculator;

test('Returns expected output when given sample input', () => {
  const input = [
    'b inc 5 if a > 1',
    'a inc 1 if b < 5',
    'c dec -10 if a >= 1',
  ...
  expect(findMaxValue(input)).toBe(1);
});

// test('Returns x when given puzzle input', () => {
//   const input = [
//     't inc 245 if xq != 0',
//     'hi inc 119 if gf >= -5',
//     'w dec 529 if s == 0',
...
//   console.log('findMaxValue', findMaxValue(input));
//   // expect(findMaxValue(input)).toBe(1);
// });
