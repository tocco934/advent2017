const findBottom = require('./').findBottom;

test('Given sample input should return tknk', () => {
  const input = ['pbga (66)',
    'xhth (57)',
    'ebii (61)',
    'havc (66)',
  ...
  expect(findBottom(input)).toBe('tknk');
});

test('Give problem input should return hmvwl', () => {
  ...
  expect(findBottom(input)).toBe('hmvwl');
});
