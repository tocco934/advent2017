const findMissingWeight = require('./').findMissingWeight;

test('Given sample input should return 60', () => {
  const input = ['pbga (66)',
    'xhth (57)',
    'ebii (61)',
    'havc (66)',
  ...
  expect(findMissingWeight(input)).toBe(60);
});

test('Give problem input should return 1853', () => {
  ...
  expect(findMissingWeight(input)).toBe(1853);
});
